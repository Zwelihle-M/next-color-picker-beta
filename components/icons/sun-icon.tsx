...
const SunIcon = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24"
      width="22"
      className="rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0 hover:text-traditionalViolet"
    >
      <g fill="black ">
        <path d="M19 12a7 7 0 11-7-7 7 7 0 017 7z" fill="black"></path>
        <path
